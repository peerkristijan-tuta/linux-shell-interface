This program has several flags. & carries out command concurrently. > imports output of command on the left to file on the right. < exports content of file of the right to command on the left. | takes output of left command to be input of right command. 
